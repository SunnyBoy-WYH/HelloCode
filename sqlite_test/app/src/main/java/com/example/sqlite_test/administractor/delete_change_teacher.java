...
public class delete_change_teacher extends AppCompatActivity implements View.OnClickListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            //编辑框绑定
            edit_xuehao_d = findViewById(R.id.edit_teacher_id_d);
            ...
            edit_xuehao_d.setText(intent_receive.getStringExtra("teacher_id"));
        ...
        public void onClick(View v) {
            ...
            switch (v.getId())
            {
                ...
                case R.id.button_teacher_baocun:
                    ...
                    values2.put("teacher_id", edit_xuehao_d.getText().toString());
